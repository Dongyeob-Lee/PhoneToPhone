...
JNIEXPORT jint JNICALL Java_com_example_remotedroid_universal_natives_FrameHandlerU_getFrameBuffer  (JNIEnv * env, jobject thiz, jbyteArray jByte, jint pixelformat){
	int		i,j,k;
	int		Dst;
	int		ret;
